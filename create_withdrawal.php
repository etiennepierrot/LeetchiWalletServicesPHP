...
$body = json_encode(array("Tag" => "Custom data", "UserID" => $user -> ID, "WalletID" => $wallet -> ID != 0 ? $wallet -> ID : $user -> ID, "Amount" => $amount, "BankAccountOwnerName" => "Test Name", "BankAccountOwnerAddress" => "Test Address", "BankAccountIBAN" => "FR30 2004 1010 1245 3072 5S03 383", "BankAccountBIC" => "CRLYFRPP"));
